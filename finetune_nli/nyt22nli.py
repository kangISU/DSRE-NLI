...
def nyt22nli_with_negative_pattern(
        instance: REInputFeatures,
        positive_templates,
        negative_templates,
        templates,
...
def main():
    ...
    parser.add_argument("--dataset", type=str, default="nyt2")
    ...
    nyt22nli_ = nyt22nli_with_negative_pattern if args.negative_pattern else nyt22nli

    with open(input_file, "rt", encoding='utf-8') as f:
        mnli_data = []
        stats = []
        for line in json.load(f):
            mnli_instance = nyt22nli_(
                REInputFeatures(
