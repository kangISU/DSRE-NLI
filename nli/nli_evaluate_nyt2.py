...
def main():
    ...
    parser.add_argument("--run_name", type=str, default='nyt2')
    parser.add_argument("--input_file", type=str, default='../dataset/nyt2/dev_test.json')

    parser.add_argument("--input_type", type=str, default='test', help='train or test, if train, then confidence will be appended')
    parser.add_argument("--output_dir", type=str, default='../dataset/nyt2', help='useful only if input_type is train')
    ...
    # parser.add_argument("--pretrained_model", type=str, default="../tmp/nli/nyt2", help='path to saved fine-tuned model')
    ...
    if args.template_type == 'genr':
        ...
        template_mapping = {
            ...
            "/business/person/company": [
                ...
                "{subj} , founder of {obj}",
                "{obj} newsman {subj}",
                "{subj} , a former president of {obj}",
